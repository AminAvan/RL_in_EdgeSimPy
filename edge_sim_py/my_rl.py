...
## Transition: a tuple representing a single transition in our environment.
...
#               It implements a .sample() for selecting a random batch of transitions for training.
...
##############
## Training ##
def initialize(rl_initialize=False):
    if (rl_initialize):
        ...
        #########################################
        ## Training loop -- optimizer definition
        def optimize_model():
